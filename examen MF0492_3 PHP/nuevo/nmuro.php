...
<div class="row">
  ...
  <div class="col-lg-8">
    ...
    <p class="lead">El auge del internet y las redes sociales.<br>
      ...
      hoy dia se conecta el mundo. Más que nunca, estamos globalizados. El mundo
       entero es un país, dividido pero conectado al mismo tiempo. Esta 
       revolución, que puede analizarse desde varios puntos de vista, tiene como 
       principal actor, como es de esperar, al internet. Se ha constituido ya 
       una herramienta indispensable para el desarrollo humano. Tenemos conexión 
       o estamos “en línea”, prácticamente en todos los momentos del dia.
      Una de las formas en que ha influencia este avance de la tecnología es la 
      forma en que se conocen las personas. Ya no es raro escuchar a varios 
      jóvenes que al preguntarles cómo ha conocido a tal persona, respondan que 
      ha sido gracias al uso de alguna red social. Es decir, las redes sociales, 
      gracias a internet, ha roto muchas barreras y permitido que personas de 
      distintas partes del planeta pueden interactuar. Como señala Borja 
      Fernandez Canel en "Las Redes Sociales. Lo que hacen sus hijos en Internet
      “La facilidad de estar en contacto con personas de tu barrio, ciudad, o 
      incluso de otros paises ha producido que las redess sociales sean 
    ...
    <blockquote class="blockquote">
      <p class="mb-0">El siguiente texto es un ensayo personal acerca de las 
      redes sociales. Se habla de cómo fue surgiendo y la manera en que ha 
      cambiado para siempre la forma en que se relacionan las personas en todo 
      el mundo.</p>
